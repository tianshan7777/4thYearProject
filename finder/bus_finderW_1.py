...
poi_data = pd.read_csv('./osm_data_clean/bus_stop_clean.csv')
...
data['bus_station'] = pd.Series(bus_list)
data.to_csv('realestatehungary_rent_houses_dis_dis_bus_10minswalk.csv', index=False)
