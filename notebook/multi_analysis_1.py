...
attributes = ['distance_to_uni1','quadratic_uni1','distance_to_uni5','quadratic_uni5','distance_to_uni13','quadratic_uni13','distance_to_uni16','quadratic_uni16']
my_list = list(combinations(attributes, 4))
