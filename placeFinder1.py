...
#Load .csv data
data = pd.read_csv('alberlet_rent_houses_pc.csv')
...
#Searching
google_places = GooglePlaces("AIzaSyDRgjNLfEQVB8t2WvZ2XqXDqAgrSpTOoeE")
...
data.to_csv('alberlet_rent_houses_pl.csv', index=False)
